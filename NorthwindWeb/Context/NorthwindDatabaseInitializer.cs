...
namespace NorthwindWeb.Context
{
    ...
    public class NorthwindDatabaseInitializer : CreateDatabaseIfNotExists<NorthwindDatabase>
    {
        ...
        private void InsertInDatabase(NorthwindDatabase context)
        {
            ...
            //orders
            context.Orders.Add(new Orders() { CustomerID = "ALFKI", EmployeeID = 2, OrderDate = new DateTime(2016, 09, 22), ShippedDate = new DateTime(2016, 10, 20), RequiredDate = new DateTime(2016, 10, 02), ShipVia = 2, Freight = (decimal?)40.26, ShipName = "Vinyl Fever", ShipAddress = "STR. 10 MAI nr. 15, DaMBOVITA", ShipCity = "Targoviste", ShipRegion = "Muntenia", ShipPostalCode = "453993", ShipCountry = "Romania" });
            context.SaveChanges();
            context.Orders.Add(new Orders() { CustomerID = "ALFKI", EmployeeID = 1, OrderDate = new DateTime(2016, 11, 18), ShippedDate = new DateTime(2016, 12, 16), RequiredDate = new DateTime(2016, 12, 01), ShipVia = 3, Freight = (decimal?)34.88, ShipName = "Vinyl Fever", ShipAddress = "STR. 10 MAI nr. 15, DaMBOVITA", ShipCity = "Targoviste", ShipRegion = "Muntenia", ShipPostalCode = "453993", ShipCountry = "Romania" });
            context.SaveChanges();
            context.Orders.Add(new Orders() { CustomerID = "ALFKI", EmployeeID = 1, OrderDate = new DateTime(2016, 12, 04), ShippedDate = new DateTime(2017, 01, 01), RequiredDate = new DateTime(2016, 12, 08), ShipVia = 3, Freight = (decimal?)3.94, ShipName = "Vinyl Fever", ShipAddress = "STR. 10 MAI nr. 15, DaMBOVITA", ShipCity = "Targoviste", ShipRegion = "Muntenia", ShipPostalCode = "453993", ShipCountry = "Romania" });
            context.SaveChanges();
            context.Orders.Add(new Orders() { CustomerID = "ANATR", EmployeeID = 8, OrderDate = new DateTime(2016, 08, 12), ShippedDate = new DateTime(2016, 09,  09), RequiredDate = new DateTime(2016, 08, 15), ShipVia = 2, Freight = (decimal?)25.83, ShipName = "Kash n", ShipAddress = "Strada Caraiman 3, Constanta", ShipCity = "Constanta", ShipRegion = "Dobrogea", ShipPostalCode = "907021", ShipCountry = "Romania" });
            context.SaveChanges();
            context.Orders.Add(new Orders() { CustomerID = "ANATR", EmployeeID = 4, OrderDate = new DateTime(2017, 02, 09), ShippedDate = new DateTime(2017, 03, 09), RequiredDate = new DateTime(2017, 02, 27), ShipVia = 2, Freight = (decimal?)86.53, ShipName = "Kash n", ShipAddress = "Strada Caraiman 3, Constanta", ShipCity = "Constanta", ShipRegion = "Dobrogea", ShipPostalCode = "907021", ShipCountry = "Romania" });
            context.SaveChanges();
            context.Orders.Add(new Orders() { CustomerID = "ANATR", EmployeeID = 4, OrderDate = new DateTime(2017, 04, 01), ShippedDate = new DateTime(2017, 04, 29), RequiredDate = new DateTime(2017, 04, 08), ShipVia = 2, Freight = (decimal?)65.99, ShipName = "Kash n", ShipAddress = "Strada Caraiman 3, Constanta", ShipCity = "Constanta", ShipRegion = "Dobrogea", ShipPostalCode = "907021", ShipCountry = "Romania" });
            context.SaveChanges();
            context.Orders.Add(new Orders() { CustomerID = "ANATR", EmployeeID = 3, OrderDate = new DateTime(2017, 08, 07), ShippedDate = new DateTime(2017, 09, 04), RequiredDate = new DateTime(2017, 08, 13), ShipVia = 1, Freight = (decimal?)43.90, ShipName = "Ana", ShipAddress = "Strada Caraiman 3, Constanta", ShipCity = "Constanta", ShipRegion = "Dobrogea", ShipPostalCode = "05021", ShipCountry = "Romania" });
            context.SaveChanges();
            context.Orders.Add(new Orders() { CustomerID = "ANTON", EmployeeID = 6, OrderDate = new DateTime(2016, 07, 31), ShippedDate = new DateTime(2016, 08, 28), RequiredDate = new DateTime(2016, 08, 29), ShipVia = 2, Freight = (decimal?)4.54, ShipName = "Tech Hifi", ShipAddress = "Piata Revolutiei 3/26, Maramures", ShipCity = "Maramures", ShipRegion = "Maramures", ShipPostalCode = "873309", ShipCountry = "Romania" });
            context.SaveChanges();
            context.Orders.Add(new Orders() { CustomerID = "ANTON", EmployeeID = 1, OrderDate = new DateTime(2016, 10, 08), ShippedDate = new DateTime(2016, 10, 22), RequiredDate = new DateTime(2016, 10, 13), ShipVia = 3, Freight = (decimal?)64.86, ShipName = "Tech Hifi", ShipAddress = "Piata Revolutiei 3/26, Maramures", ShipCity = "Maramures", ShipRegion = "Maramures", ShipPostalCode = "873309", ShipCountry = "Romania" });
            context.SaveChanges();
            context.Orders.Add(new Orders() { CustomerID = "AROUT", EmployeeID = 7, OrderDate = new DateTime(2016, 10, 01), ShippedDate = new DateTime(2016, 10, 29), RequiredDate = new DateTime(2016, 10, 10), ShipVia = 3, Freight = (decimal?)64.50, ShipName = "Beatties", ShipAddress = "STR. VULCAN SAMUIL nr. 16, BEIUS", ShipCity = "BIHOR", ShipRegion = "Crisana", ShipPostalCode = "653271", ShipCountry = "Romania" });
            context.SaveChanges();
            context.Orders.Add(new Orders() { CustomerID = "AROUT", EmployeeID = 6, OrderDate = new DateTime(2016, 11, 14), ShippedDate = new DateTime(2016, 12, 12), RequiredDate = new DateTime(2016, 11, 19), ShipVia = 1, Freight = (decimal?)41.95, ShipName = "Around the Horn", ShipAddress = "Brook Farm Stratford St. Mary", ShipCity = "Colchester", ShipRegion = "Essex", ShipPostalCode = "CO7 6JX", ShipCountry = "UK" });
            context.SaveChanges();
            context.Orders.Add(new Orders() { CustomerID = "AROUT", EmployeeID = 1, OrderDate = new DateTime(2016, 12, 08), ShippedDate = new DateTime(2017, 01, 05), RequiredDate = new DateTime(2016, 12, 12), ShipVia = 3, Freight = (decimal?)22.21, ShipName = "Beatties", ShipAddress = "STR. VULCAN SAMUIL nr. 16, BEIUS", ShipCity = "BIHOR", ShipRegion = "Crisana", ShipPostalCode = "653271", ShipCountry = "Romania" });
            context.SaveChanges();
            context.Orders.Add(new Orders() { CustomerID = "AROUT", EmployeeID = 1, OrderDate = new DateTime(2017, 02, 20), ShippedDate = new DateTime(2017, 03, 20), RequiredDate = new DateTime(2017, 02, 25), ShipVia = 2, Freight = (decimal?)25.36, ShipName = "Around the Horn", ShipAddress = "Brook Farm Stratford St. Mary", ShipCity = "Colchester", ShipRegion = "Essex", ShipPostalCode = "CO7 6JX", ShipCountry = "UK" });
            context.SaveChanges();
            context.Orders.Add(new Orders() { CustomerID = "AROUT", EmployeeID = 2, OrderDate = new DateTime(2017, 05, 28), ShippedDate = new DateTime(2017, 06, 25), RequiredDate = new DateTime(2017, 06, 04), ShipVia = 1, Freight = (decimal?)83.22, ShipName = "Beatties", ShipAddress = "STR. VULCAN SAMUIL nr. 16, BEIUS", ShipCity = "BIHOR", ShipRegion = "Crisana", ShipPostalCode = "653271", ShipCountry = "Romania" });
            context.SaveChanges();
            context.Orders.Add(new Orders() { CustomerID = "BERGS", EmployeeID = 1, OrderDate = new DateTime(2016, 07, 31), ShippedDate = new DateTime(2016, 08, 28), RequiredDate = new DateTime(2016, 08, 01), ShipVia = 1, Freight = (decimal?)136.54, ShipName = "Cut Above", ShipAddress = "Bulevardul Ion Mihalache 148B, Bucuresti", ShipCity = "Bucuresti", ShipRegion = "Muntenia", ShipPostalCode = "666708", ShipCountry = "Romania" });
            context.SaveChanges();
            context.Orders.Add(new Orders() { CustomerID = "BLAUS", EmployeeID = 1, OrderDate = new DateTime(2016, 12, 31), ShippedDate = new DateTime(2017, 01, 28), RequiredDate = new DateTime(2017, 01, 15), ShipVia = 3, Freight = (decimal?)83.93, ShipName = "Sears Homelife", ShipAddress = "STR. 9 MAI, BACAU", ShipCity = "Bacau", ShipRegion = "Moldova 546708", ShipCountry = "Romania" });
            context.SaveChanges();
            context.Orders.Add(new Orders() { CustomerID = "BLAUS", EmployeeID = 2, OrderDate = new DateTime(2017, 01, 06), ShippedDate = new DateTime(2017, 02, 03), RequiredDate = new DateTime(2017, 01, 29), ShipVia = 2, Freight = (decimal?)91.48, ShipName = "Sears Homelife", ShipAddress = "STR. 9 MAI, BACAU", ShipCity = "Bacau", ShipRegion = "Moldova 546708", ShipCountry = "Romania" });
            context.SaveChanges();
            context.Orders.Add(new Orders() { CustomerID = "BLAUS", EmployeeID = 4, OrderDate = new DateTime(2017, 04, 16), ShippedDate = new DateTime(2017, 05, 14), RequiredDate = new DateTime(2017, 04, 28), ShipVia = 1, Freight = (decimal?)0.15, ShipName = "Blauer See", ShipAddress = "Delikatessen Forsterstr. 57 ", ShipCity = "Mannheim", ShipPostalCode = "68306", ShipCountry = "Germany" });
            context.SaveChanges();
            context.Orders.Add(new Orders() { CustomerID = "BLONP", EmployeeID = 2, OrderDate = new DateTime(2016, 07, 24), ShippedDate = new DateTime(2016, 08, 21), RequiredDate = new DateTime(2016, 08, 11), ShipVia = 1, Freight = (decimal?)55.28, ShipName = "Blondel père et fils", ShipAddress = "STR. BARNUTIU SIMION nr. 67, SALAJ", ShipCity = "SALAJ", ShipRegion = "Transilvania", ShipPostalCode = "67000", ShipCountry = "Romania" });
            context.SaveChanges();
            context.Orders.Add(new Orders() { CustomerID = "BLONP", EmployeeID = 4, OrderDate = new DateTime(2016, 08, 22), ShippedDate = new DateTime(2016, 09, 19), RequiredDate = new DateTime(2016, 09, 02), ShipVia = 1, Freight = (decimal?)7.45, ShipName = "Century House", ShipAddress = "STR. BARNUTIU SIMION nr. 67, SALAJ", ShipCity = "SALAJ", ShipRegion = "Transilvania", ShipPostalCode = "67000", ShipCountry = "Romania" });
            context.SaveChanges();
            context.Orders.Add(new Orders() { CustomerID = "BLONP", EmployeeID = 4, OrderDate = new DateTime(2016, 11, 21), ShippedDate = new DateTime(2016, 12, 19), RequiredDate = new DateTime(2016, 12, 01), ShipVia = 3, Freight = (decimal?)131.70, ShipName = "Blondel père et fils", ShipAddress = "STR. BARNUTIU SIMION nr. 67, SALAJ", ShipCity = "SALAJ", ShipPostalCode = "67000", ShipCountry = "Romania" });
            context.SaveChanges();
            context.Orders.Add(new Orders() { CustomerID = "BLONP", EmployeeID = 1, OrderDate = new DateTime(2017, 01, 05), ShippedDate = new DateTime(2017, 02, 02), RequiredDate = new DateTime(2017, 01, 21), ShipVia = 1, Freight = (decimal?)34.82, ShipName = "Century House", ShipAddress = "STR. BARNUTIU SIMION nr. 67, SALAJ", ShipCity = "SALAJ", ShipRegion = "Transilvania", ShipPostalCode = "67000", ShipCountry = "Romania" });
            context.SaveChanges();
            ...
            InsertInDatabaseViews(context);

        }

        //create view for Northwind Database
        private void InsertInDatabaseViews(NorthwindDatabase context)
        {
            //view sql create view Order Subtotals
...
GROUP BY [Order Details].OrderID");
            ...
            //view sql create view SummaryOfSalesByYear
            context.Database.ExecuteSqlCommand(@"
create view [dbo].[Summary of Sales by Year] AS
SELECT Orders.ShippedDate, Orders.OrderID, [Order Subtotals].Subtotal
FROM Orders INNER JOIN [Order Subtotals] ON Orders.OrderID = [Order Subtotals].OrderID");

            //view sql create view SummaryOfSalesByQuarter
            context.Database.ExecuteSqlCommand(@"create view [dbo].[Summary of Sales by Quarter] AS
SELECT Orders.ShippedDate, Orders.OrderID, [Order Subtotals].Subtotal
FROM Orders INNER JOIN [Order Subtotals] ON Orders.OrderID = [Order Subtotals].OrderID
WHERE Orders.ShippedDate IS NOT NULL");

            //view sql create view SalesTotalsByAmount 
            context.Database.ExecuteSqlCommand(@"
...
WHERE([Order Subtotals].Subtotal > 2500) AND(Orders.ShippedDate BETWEEN 19970101 And 19971231)");
            ...
            //view sql create view OrderDetailsExtended 
            context.Database.ExecuteSqlCommand(@"
...
FROM Products INNER JOIN [Order Details] ON Products.ProductID = [Order Details].ProductID");
            ...
            //view sql create view SalesByCategory 
            context.Database.ExecuteSqlCommand(@"
...
GROUP BY Categories.CategoryID, Categories.CategoryName, Products.ProductName");
            ...
            //view sql create view QuaterlyOrders 
            context.Database.ExecuteSqlCommand(@"
...
WHERE Orders.OrderDate BETWEEN 19970101 And 19971231");
            ...
            //view sql create view ProductsByCategory 
            context.Database.ExecuteSqlCommand(@"
...
WHERE Products.Discontinued <> 1");
            ...
            //view sql create view ProductsAboveAveragePrice 
            context.Database.ExecuteSqlCommand(@"
...
WHERE Products.UnitPrice>(SELECT AVG(UnitPrice) From Products)");
            ...
            //view sql create view ProductSalesFor1997 
            context.Database.ExecuteSqlCommand(@"
...
GROUP BY Categories.CategoryName, Products.ProductName");
            ...
            //view sql create view OrdersQry 
            context.Database.ExecuteSqlCommand(@"
...
FROM 	Shippers INNER JOIN 
	...
	ON Shippers.ShipperID = Orders.ShipVia");
            ...
            //view sql create view CustomerAndSuppliersByCity
            context.Database.ExecuteSqlCommand(@"
...
FROM Suppliers");
            ...
            //view sql create view CurrentProductList = 
            context.Database.ExecuteSqlCommand(@"
...
WHERE (((Product_List.Discontinued)=0))");
            ...
            //view sql create view CategorySalesFor1997 = 
            context.Database.ExecuteSqlCommand(@"
...
GROUP BY [Product Sales for 1997].CategoryName");
            ...
            //view sql create view AlphabeticalListOfProducts = 
            context.Database.ExecuteSqlCommand(@"
