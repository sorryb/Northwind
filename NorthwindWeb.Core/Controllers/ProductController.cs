...
namespace NorthwindWeb.Controllers
{
    ...
    public class ProductController : Controller, IJsonTableFillServerSide
    {
        ...
        public async Task<ActionResult> Details(int? id)
        {
            ...
            ViewBag.search = Request.Query["search"];
        ...
        public async Task<ActionResult> DeleteConfirmed(int id)
        {
            try
            {
                ...
                System.IO.File.Delete(System.IO.Path.Combine(Startup._hostingEnvironment.ContentRootPath.ToString() + ($"~/images/{db.Categories.Where(x => x.CategoryID == products.CategoryID).FirstOrDefault().CategoryName}/"), $"{id}.jpg"));
            }
            catch (NullReferenceException e)
            {
            ...
            return RedirectToAction("Index", "Product", new { category = Request.HttpContext.Request.Query["category"], search = Request.HttpContext.Request.Query["search"]});
        }
