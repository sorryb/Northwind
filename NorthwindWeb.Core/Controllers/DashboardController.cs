...
using NorthwindWeb.Core.ViewModels.Dashboard;
...
namespace NorthwindWeb.Controllers
{
    ...
    public class DashboardController : Controller
    {
        ...
        public DashboardController(NorthwindDatabase context)
        {
            db = context;
        }
        ...
        public ActionResult Search(string search, int? page, string currentFilter)
        {
            ...
            viewModel.MatchesFound = machesFount.ToList();
            viewModel.MatchesFoundPaged = machesFount.ToList();
            return View(viewModel);
        ...
        public JsonResult MorrisArea()
        {
            ...
            {
                itemDashboardMorrisAreaData.Sales = decimal.Floor(itemDashboardMorrisAreaData.Sales);
            }
            return Json(dashboardMorrisAreaData);
        }
        /// <summary>
        ...
        public JsonResult MorrisDonut()
        {
            ...
            foreach (var itemDashboardMorrisDonutData in dashboardMorrisDonutData)
            {
                itemDashboardMorrisDonutData.value = decimal.Floor(itemDashboardMorrisDonutData.value);
            }

            return Json(dashboardMorrisDonutData);
        }
        ...
        private List<DashboardMorrisBar> SalesByQuarter()
        {
            ...
            {
                {
                    itemDashboardMorrisBarData.dashboardMorrisBarColumA = decimal.Floor(itemDashboardMorrisBarData.dashboardMorrisBarColumA);
                    itemDashboardMorrisBarData.dashboardMorrisBarColumB = decimal.Floor(itemDashboardMorrisBarData.dashboardMorrisBarColumB);
                    itemDashboardMorrisBarData.dashboardMorrisBarColumC = decimal.Floor(itemDashboardMorrisBarData.dashboardMorrisBarColumC);
                }
            }
        ...
        private decimal TotalSalesValue()
        {
            ...
            totalSalesValue = decimal.Floor(totalSalesValue);
        ...
        private List<LastTenOrders> LastTenOrder()
        {
            ...
            foreach (var itemOrder in order)
            {
                ...
                if (pastTime.TotalMinutes <= 60) { lastTenOrdersElement.Ago = "Acum " + Convert.ToString(decimal.Floor(Convert.ToDecimal(pastTime.TotalMinutes))) + " de Minute"; }
                else if (pastTime.TotalHours <= 24) { lastTenOrdersElement.Ago = "Acum " + Convert.ToString(decimal.Floor(Convert.ToDecimal(pastTime.TotalHours))) + " Ore"; }
                else if (pastTime.TotalDays <= 30) { lastTenOrdersElement.Ago = "Acum " + Convert.ToString(decimal.Floor(Convert.ToDecimal(pastTime.TotalDays))) + " Zile"; }
